...
{
    public static ChatSession CreateSession(AiOptions options, string? aiProxyHostPath, string prompt, TokenReductionStrategy tokenStrategy = TokenReductionStrategy.None, string? chatFunctionPrompt = null, string[]? chatFunctionParameters = null, string? logDirectoryPath = null, string? logLevel = null, IChatService? chatService = null, int latestContextLimit = -1)
    {
        ...
        return new ChatSession(targetChatService, prompt, tokenStrategy, null, targetChatFunctionPrompt, chatFunctionParameters, latestContextLimit);
    }
}
